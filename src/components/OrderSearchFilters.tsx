...
const OrderSearchFilters: React.FC<OrderSearchFiltersProps> = ({
  ...
  return (
    <div className="space-y-4 p-4">
      <div>
        <label htmlFor="search-order-number" className="block text-sm font-medium text-gray-700 mb-1">Cerca Numero Ordine</label>
      ...
      <div>
        <label htmlFor="start-date" className="block text-sm font-medium text-gray-700 mb-1">Data Ordine (Da)</label>
        <Popover>
      ...
      <div>
        <label htmlFor="end-date" className="block text-sm font-medium text-gray-700 mb-1">Data Ordine (A)</label>
        <Popover>
          <PopoverTrigger asChild>
            <Button
              variant={"outline"}
